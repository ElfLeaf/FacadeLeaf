 ...
 * @version 1.0
 */
public abstract class AbstractMyTextPaster implements TextPaster {
    /**
     ...
     */
    AbstractMyTextPaster(Integer minAcceptedWordLength, Integer maxAcceptedWordLength) {
     ...
     */
    AbstractMyTextPaster(Integer minAcceptedWordLength, Integer maxAcceptedWordLength, Color textColor) {
